...
# Provides the framework for the game.
...
'''
import pygame
# Added so we can easily quit the game
import sys
...
class PygameGame(object):
    ...
    def __init__(self, width=600, height=400, fps=50, title="Galagagalag"):
        self.width = width
        self.height = height
        self.fps = fps
        self.title = title
    ...
    def run(self):
        ...
        # pygame.quit doesn't close window; maybe it's deprecated in Python 3?
        # Grabbed from:
        # https://stackoverflow.com/questions/5615860/pygame-screen-freezes-when-i-close-it
        sys.exit()
